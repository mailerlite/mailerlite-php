...
$response = $mailerlite->subscriber->create($data);
```
...
$response = $mailerLite->subscriber->read($subscriberId);
```
...
$response = $mailerLite->subscriber->readAll();
```
...
$response = $mailerlite->subscriber->update($subscriberId, $data);
```
...
$response = $mailerlite->subscriber->delete($subscriberId);
```
