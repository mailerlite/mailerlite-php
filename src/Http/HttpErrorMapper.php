...
final class HttpErrorMapper
{
    public static function throwIfError(ResponseInterface $r): void
    {
        ...
        match ($code) {
            401 => throw new Unauthorized($message, 401, $body, $headers),
            403 => throw new Forbidden($message, 403, $body, $headers),
            404 => throw new NotFound($message, 404, $body, $headers),
            429 => throw new TooManyRequests($message, 429, $body, $headers),
            default => $code >= 500
